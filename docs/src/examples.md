...
| 11 | Hypothesis Tests | `adf_test`, `kpss_test`, `johansen_test`, `granger_test` | ADF, KPSS, Zivot-Andrews, Ng-Perron, Johansen, Granger causality |
...
## Example 4: Three-Variable VAR Analysis
...
## Example 8: Factor Model for Large Panels
...
## Example 10: Non-Gaussian Identification
...
## Example 13: Table Output — Text, LaTeX, and HTML
...
## Example 14: Bibliographic References
